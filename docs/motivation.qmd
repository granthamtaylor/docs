...
pyproject: |
  ...
  dependencies = [
    "marimo>=0.23.8",
    "json2vec[serving] @ file:///Users/grantham/Desktop/json2vec-oss",
  ]
---
...
| Schema evolution | Schema mutation APIs |
| Datatype plugins | [Built-In Data Types](core-concepts/data-types.qmd) |
| Explainability | [Learning Modes & Embeddings](core-concepts/embeddings.qmd) |
| Querying and wrangling | [Query Paths](core-concepts/querypaths.qmd), preprocessors |
...
mutation APIs for the update workflow.
