...
For messy data, use preprocessors when you need
Python logic such as type coercion, windowing, sorting, or splitting one raw
record into multiple observations. Use [custom queries](core-concepts/querypaths.qmd)
...
- **Change schemas after construction:** schema mutation APIs
